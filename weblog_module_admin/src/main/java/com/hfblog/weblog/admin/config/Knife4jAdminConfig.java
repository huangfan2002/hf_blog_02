package com.hfblog.weblog.admin.config;
...
public class Knife4jAdminConfig {
    ...
    public Docket createApiDoc() {
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.hfblog.weblog.admin.controller"))
    ...
    private ApiInfo buildApiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("丁真", "https://www.quanxiaoha.com", "871361652@qq.com")) // 联系人
                .version("1.0") // 版本号
                .build();
    }
}